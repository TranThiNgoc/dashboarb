...
<link type="text/css"  rel="stylesheet"    href=" all.css"></link>s
    <link type="text/css" rel="stylesheet" href="source/new.css">
</head>
<body>
<header>
    <ul  class="stu" style="height: 50px;background-color: lightskyblue; padding-left: 78%; padding-top: 9px; position: relative; ">
...
{{--                </li>--}}
    ...
    <div  class="center" style="width: 80%;height: 300px; display:table-cell ;">
