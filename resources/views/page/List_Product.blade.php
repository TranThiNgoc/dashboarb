...
{{--            i++;--}}
            <div style="margin: 20px;padding-right: 10px;float: left;width: 150px;background-color:#fdfdfe">
                ...
                <div style="margin: 20px;padding-top: 9px">
                    ...
                    <div class="thumbnail">
                        ...
                        <div style=" background-color:sandybrown;width: 80px;">

                            <a  href="{{route('themgiohang',$item->id)}}"style="color: white;text-decoration: none;"  > Add to cart</a>
                        </div>
